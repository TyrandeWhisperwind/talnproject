...
def split_sentences(st):
    ...
    if sentences[-1]:
        ...
        return sentences[:-1]
###############################################################################################
os.chdir("C:/Users/HP/Desktop/TAL/Projet/scond step/656-1213")#all the files of that phase
corpus=open("C:/Users/HP/Desktop/TAL/Projet/scond step/corpus_عصر الدول المتتابعة.txt",encoding="utf-8",mode="w")#create a new tagged curpos
corpus.write("<t>")
corpus.write("<text id=\"عصر الدول المتتابعة\">")#tag of the phase (656-1213 hidjri)
corpus.write("\n")
liste=[]
listeSentences=[]
